                            ...
                            <div className="categories-card__details">
                                ...
                                <div className="categories-card__inline">
                                    ...
                                    <div className="more-btn">
                                        <button className="btn btn-more" onClick={() => {toggleDropdown(item?._id);setDisc(item?.description)} }>
                                            <FaEllipsisV />
                                        </button>
                                        {openDropdownId === item?._id && (
                                            <div className="dropdown-menu-card">
                                                <ul>
                                                    ...
                                                    <li>
                                                        <button href="#" onClick={()=>{ handleNotIntrested(item?._id); setOpenDropdownId(null); }}>
                                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
