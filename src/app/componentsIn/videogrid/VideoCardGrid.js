...
const VideoCard = ({ video,index,substance ,mentalHealth,neuroScience, socialIssues,handleInterestFilter,interest,data ,getFolder, rename, setValue, handleCreateFolder, handleDeleteFolder, handleRename, handleSaveVideo, setSelectedFolderId, setRename,handleNotIntrested,getSubFolder,getSaveVideo}) => {
...
const [show1, setShow1] = useState(false);
 ...
 const [show6, setShow6] = useState(false);
    ...
    <Modal open={renameModel} show={show7} onHide={handleClose7} onClick={() => setSubfolder("Subfolder")} centered className='custom-modal'>
                ...
                <div className="video-card">
                    <div className="video-card-content">
                        <div onClick={() => {handleNavigate(video)}}> 
                            <div className="video-card-image " >
                            <Link href={`/mainHome/${video?._id}/videodetails2`}><Image src={ video?.thumbnail ?video?.thumbnail: defoultImages} alt="video card" width={300}  height={150} /></Link>
                                    ...
                                    {isDropdownOpen && (
                                        <div className="dropdown-menu-card">
                                            <ul>
                                                ...
                                                <li>
                                                    <button onClick={()=>{handleNotIntrested(video?._id);setIsDropdownOpen(false); }}>
                                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
