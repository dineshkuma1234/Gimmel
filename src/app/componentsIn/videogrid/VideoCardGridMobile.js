...
const VideoCard = ({ video, index, topicPost }) => {
        ...
        <div className="page-slider-section mb-4">
          <div className="slider-title">
            <div className="inline-gap-8">
              <h3>
                Teachers like you share this with their class about{" "}
                <Link href="#">addiction prevention</Link>:
              </h3>
...
const VideoCardGrid = ({ getPost, topicPost }) => (
