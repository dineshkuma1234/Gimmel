...
function UserProfile({
  ...
  const handleAgeChange = (text) => {
    ...
    setAge({
      ...
      value: text,
      error:
        isNaN(min) || isNaN(max) ? "Enter a valid age range (e.g., 1-80)." : "",
    });
  };
      ...
      <main id="main" className="top-space account-details">
        <div className="custom-container">
          <div className="account-details-inner">
            ...
            <div className="user-edit-container">
              <div className="user-edit">
                <button className="user-edit-btn" onClick={handleShow}>
                  Edit data
                </button>
              </div>
            </div>
          ...
          <div className="account-full-info">
            <div className="account-full-info-inner">
              ...
              <div className="account-full-info-item">
                ...
                <div className="account-full-info-item-value w-50">
                  <p>
                    {profileInfo?.onboarding?.teachingTopics?.join(", ") || ""}
                  </p>
                </div>
              </div>
              <div className="account-full-info-item">
                ...
                <div className="account-full-info-item-value w-50">
                  <p>
                    {profileInfo?.onboarding?.contentMaturityRestrictions?.join(
                      ", "
                    ) || ""}
                  </p>
                </div>
              ...
              <div className="account-full-info-item">
                ...
                <div className="account-full-info-item-value w-50">
                  <p>
                    {profileInfo?.onboarding?.educationalObjectives?.join(
                      ", "
                    ) || ""}
                  </p>
                </div>
            ...
            <div className="account-plan">
              <div className="plan-header">
                <div className="plan-header-title">
                  <Image
                    src={require("../../../assets/images/currency_exchange.svg")}
                    alt="User Avatar"
                  />
              ...
              <div className="plan-body">
                ...
                <div className="row mx-n3">
                  ...
                  <div className="col-sm-12 col-xl-12 mb-3">
                    <div className="card card-frame active">
                      ...
                      <button type="button" className="btn-color-orange mt-2">
                        Upgrade
                      </button>
                    </div>
                  </div>
                ...
                <div className="active-plan-info">
                  Currently you have an active{" "}
                  <b className="active-plan-name">Free Plan </b>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="logout-btn pb-3">
            <Link href="/logoutconfirmation" className="btn-logout ">
              <MdLogout />
              Logout
            </Link>
          </div>
