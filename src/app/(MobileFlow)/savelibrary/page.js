...
function SaveLibrary() {
    ...
    const {handleCreateFolder,getFolder,handleRename}=useSave();
...
//   setRenameFolderId(folderId); // If you want to know which folder to rename
};
  ...
  if (!event.target.closest('.dropdown-menu-card') && !event.target.closest('.folder-icon')) {
                    ...
                    <div className="modal-body-container">
                        <div className="input-container modal-input">
                            <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
                                ...
                                <Form.Control type="text" placeholder="" onChange={(e)=>setRenameFolder(e.target.value)}  />
                            </Form.Group>
                        </div>
                    </div>
                    <div className="btn-container">
                        <button className="btn btn-color-orange" onClick={()=>{handleClose(); handleRename(renameFolder,id);}}>Save</button>
                    </div>
                </Modal.Body>
            </Modal>
                    ...
                    <div className="form-group">
                        <div className="input-container modal-input">
                            <Form.Group className="mb-4" controlId="exampleForm.ControlInput1">
                                <Form.Label>Folder name</Form.Label>
                                <Form.Control type="text" placeholder="" onChange={(e)=>setNewFolderName(e.target.value)}/>
                            </Form.Group>
                        </div>
                    </div>
