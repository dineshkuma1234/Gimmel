                      ...
                      <div className="folder-content-inline">
                        {/* <Link href="/savelibrary/folder_id/folder"> */}
                          <div className="folder-content-left">
                            ...
                            <div className={`folder-name${selectedSubFolder === folder?._id ? " active" : ""}`}  onClick={()=>setSelectedSubFolder(folder?._id)}>
                              <p>{folder.name}</p>
                            </div>
                          </div>
                        {/* </Link> */}
                      ...
                      <div className="video-item-inline">
                        <div className="video-item-left">
                          <div className="video-item-thumbnail">
                            <Image src={video.thumbnailUrl} alt="thumbnail" height={100} width={100} />
                          </div>
                        </div>
      ...
      <div className="bottom-btn-bar">
        <div className="bottom-btn-bar-inner">
          <button
            ...
            onClick={()=>handleSaveSubFolderVideo(selectedSubFolder,selectedFolderId)}
