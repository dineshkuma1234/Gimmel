    ...
    <>
      ...
      >
              ...
              <Form className="request-data-form-overview">
                ...
                >
                  ...
                  <Form.Control
                    type="text"
                    readOnly
                    placeholder="Understanding and Managing Anxiety in Teenagers"
                    value={yourRequest}
                  />
                </Form.Group>
                <Form.Group
                ...
                >
                  <Form.Label>Material discription</Form.Label>
                  <Form.Control
                    as="textarea"
                    readOnly
                    placeholder="A 15-minute video explaining the causes of anxiety in teenagers, signs to watch for, and practical strategies for managing it. It should include interviews with mental health professionals and real-life testimonials."
                    className="height-96"
                    value={discription}
                  />
                ...
                >
                  ...
                  <Form.Control
                    as="textarea"
                    readOnly
                    placeholder="Avoid discussing severe psychological disorders, and do not use any technical mental health jargon that requires advanced knowledge."
                    className="height-96"
                    value={avoided}
                  />
                  <div className="count-text">0/60</div>
                ...
                <Form.Group className="" controlId="exampleForm.ControlInput4">
                  ...
                  <Form.Control
                    as="textarea"
                    readOnly
                    placeholder="The material should be friendly and accessible for both teens and parents, using simple language and clear examples. Provide resources for further help, like counseling services."
                    className="height-96"
                    value={details}
                  />
                  <div className="count-text">0/60</div>
        ...
        <div className="bottom-btn-bar">
          <div
            className="bottom-btn-bar-inner"
            onClick={() => {
              handleCreateRequest(yourRequest, discription, avoided, details);
            }}
          >
            <Link
              href={"/requestmobile/request-success"}
