...
function WatchVideo({
  ...
  const [showsummary, setShowshowsummary] = useState(false);

  const handleCloseshowsummary = () => setShowshowsummary(false);
  const handleShowshowsummary = () => setShowshowsummary(true);
        ...
        <Modal.Body>
          <div className="modal-body-container">
            <div className="share-comtent">
              ...
              <div className="details-item">
                <div className="light-text">Creator</div>
                <div className="bold-text">{data?.channelName}</div>
                <div className="dropdown-divider"></div>
              </div>
              <div className="details-item">
                <div className="light-text">
                ...
                <div className="bold-text">{/* Yes */}</div>
                <div className="dropdown-divider"></div>
              </div>
              <div className="details-item">
                <div className="light-text">Published/Uploaded</div>
                <div className="bold-text">
              ...
              <div className="details-item">
                <div className="light-text">Targeted audience</div>
                <div className="bold-text">1st - 4th grade</div>
                <div className="bold-text">5th - 8th grade</div>
                <div className="dropdown-divider"></div>
              </div>
              <div className="details-item">
                <div className="light-text">Age group</div>
                <div className="bold-text">{data?.ageRange}</div>
                <div className="dropdown-divider"></div>
              </div>
              <div className="details-item">
                <div className="light-text">Content type</div>
                <div className="bold-text">Animated video</div>
                <div className="dropdown-divider"></div>
              </div>
              <div className="details-item">
                <div className="light-text">Subject area</div>
                <div className="bold-text">Substance Use</div>
                <div className="bold-text">Neuroscience</div>
                <div className="dropdown-divider"></div>
              </div>
              <div className="details-item">
                <div className="light-text">Duration</div>
                <div className="bold-text">12:32</div>
              </div>
            </div>
          </div>
        </Modal.Body>
        ...
        <Modal.Body>
          <div className="modal-body-container">
            <div className="report-material">
              <Image
                src={require("../../../assets/images/report-material.svg")}
                alt="Details"
              />
            </div>
            <div className="share-comtent">
                ...
                <div className="page-tbs-container mt-3">
                  ...
                  >
                    <Col sm={12}>
                      <Nav
                        variant="pills"
                        className="flex-row details-tabs-mobile"
                      >
                        <Nav.Item>
                          ...
                          <div className="page-tbs-container mt-3">
                            ...
                            >
                              <Col sm={12}>
                                <Nav
                                  variant="pills"
                                  className="flex-row details-tabs"
                                >
                                  <Nav.Item>
