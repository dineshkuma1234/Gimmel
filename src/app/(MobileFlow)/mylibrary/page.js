                    ...
                    <div className="folder-inner">
                      <div className="folder-content-inline">
                        {/* <Link href="/mylibrary/folder_id/folder"> */}
                          <div className="folder-content-left" onClick={()=>{  setSelectedFolderId(folder._id); setSelectIcon(prev => !prev); router.push(`/mylibrary/${folder._id}/folder?folderName=${encodeURIComponent(folder?.name)}`);}}>
