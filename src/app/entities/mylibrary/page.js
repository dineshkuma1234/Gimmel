...
function MyLibrary() {
    ...
    const {getFolder,handleRename,selectedFolderId,setSelectedFolderId,handleDeleteFolder,selectSortValue,setSelectSortValue}=useSave();
                    ...
                    <div className="modal-body-container">
                        <div className="input-container modal-input">
                            <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
                                ...
                                <Form.Control type="text" placeholder="" onChange={(e)=>{setRename(e.target.value)}}/>
                            </Form.Group>
                        </div>
                    </div>
                    <div className="btn-container">
                        <button className="btn btn-color-orange" onClick={()=>{handleClose(); handleRename(rename,selectedFolderId)}}>Save</button>
                    </div>
                </Modal.Body>
            </Modal>
            ...
            <Modal show={show2} onHide={handleClose2} centered className='custom-modal'>
                <Modal.Body>
                    ...
                    <div className="btn-container d-flex gap-3">
                        <button className="btn btn-color-orange" onClick={()=>{handleClose2();handleDeleteFolder(selectedFolderId)}}>Delete</button>
                                            ...
                                            <div className="folder-content-right" >
                                                ...
                                                {isDropdownOpen === folder._id && (
                                                    <div className="dropdown-menu-card">
                                                        <ul>
                                                            <li>
                                                                <button variant="primary" onClick={()=>handleShow(folder?._id)}>
                                                                    <TbEdit />
                                                                    Rename
                                                                </button>
                                                            </li>
                                                            <li className="hide_mobile">
                                                                <button variant="primary" onClick={()=>handleShow2(folder?._id)}>
                                                                    <MdDeleteOutline />
                                                                    Delete
                                                                </button>
                                                            </li>
