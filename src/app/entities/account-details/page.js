        ...
        <Modal.Body>
          <div className="modal-body-container">
            ...
            <div className="btn-container">
              ...
              <button
                className="btn-color-orange-transprent "
      ...
      <main id="main" className="top-space">
        <div className="custom-container">
                  ...
                  <Form className="question-select">
                    ...
                    >
                      ...
                      <div className="col-9">
                        ...
                        />
                        {error1 && (
                          <span className="error-message">{error1}</span>
                        )}
                      </div>
                    </Form.Group>
                    <Form.Group
                        ...
                        {!isEditable ? (
                          ...
                          <MultiSelect
                            ...
                            valueRenderer={(selected1) =>
                              selected1.length
                                ? selected1.map(({ label }) => label).join(", ")
                                : "Select topics"
                            }
                          />
                        )}
                    ...
                    <div className="text-right" style={{ textAlign: "right" }}>
                      ...
                      >
                        {" "}
                        {isEditable ? "Save Changes" : "Edit data"}
                      </button>
                    </div>
                  </Form>
                </div>
            ...
            <div className="card-inner-padding">
              ...
              <div id="pricingSection" className="mt-4">
                <div className="container">
                  ...
                  >
                    <span
                      className={`switch-label ${!isYearly ? "active" : ""}`}
                    >
                      Yearly
                    </span>
                    <label className="switch">
              ...
              <div className="library-list mt-4 position-relative">
                ...
                >
                  {watchHistoryData &&
                    ...
                    watchHistoryData.slice(0, 10).map((item, index) => (
                      <SwiperSlide key={index}>
                        <div className="col-md-12">
                          <div className="video-card">
                            <div className="video-card-content">
          ...
          <div className="log-out">
            <button className="btn-logout" onClick={handleShow2}>
              <FiLogOut /> Logout
            </button>
          </div>
        </div>
