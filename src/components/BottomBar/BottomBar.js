            ...
            <ul className="menu-list">
              ...
              <li className="menu-item">
                <Link
                  href="/search"
                  className={`menu-link ${
                    pathname === "/search" || pathname === "/search/searchlist"
                      ? "active"
                      : ""
                  }`}
                >
