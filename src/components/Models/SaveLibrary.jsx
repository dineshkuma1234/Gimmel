    ...
    <>
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title>
            {subFolderView && (
              <button className="modal-back-btn" type="button" onClick={() => setSubfolderView(false)}>
        ...
        <Modal.Body>
          ...
          {!subFolderVideos && !subFolderView  && (
            <div className="body-footer">
              <div className="add-new-folder mb-3">
                <button
                  type="button"
                  className="btn btn-new-folder"
                  onClick={show_new_folder_popup}
